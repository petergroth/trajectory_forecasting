...
class WaymoUAExp(pl.LightningModule):
    def __init__(
            self,
...
class WaymoUAExpAlt(pl.LightningModule):
    def __init__(
            self,
            model_type: Union[None, str],
            model_dict: Union[None, dict],
    ...
    def test_step(self, batch: Batch, batch_idx: int):
        ...
        loss = mean_nllh
        self.log("test_fde_ttp_loss", fde_ttp_loss, batch_size=fde_ttp_mask.sum().item())
        self.log("test_ade_ttp_loss", ade_ttp_loss, batch_size=ade_ttp_mask.sum().item())
...
class WaymoUASoftplus(pl.LightningModule):
    def __init__(
            self,
            model_type: Union[None, str],
            model_dict: Union[None, dict],
